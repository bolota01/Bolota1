INTERIORS = {
    ...
    -- Coca 
    [30] = {id = 30, x = 2452.1115722656, y = 4969.0771484375, z = 46.57160949707,  name = "Entrar", destination = {31}},
    [31] = {id = 31, x = 2453.318359375, y = 4970.6689453125, z = 46.810512542724,  name = "Sair", destination = {30}},

INTERIORS = {
    ...
    -- Maconha 
    --[[[26] = {id = 26, x = 1065.1346435547, y = -3183.9592285156, z = -39.163822174072,  name = "Entrar", destination = {27}},
    [27] = {id = 27, x = 648.59875488281, y = 2720.3842773438, z = 41.850166320801,  name = "Sair", destination = {26}},

    -- Meta 
    [28] = {id = 28, x = 997.65112304688, y = -3200.8054199219, z = -36.393646240234,  name = "Entrar", destination = {29}},
    [29] = {id = 29, x = 675.01324462891, y = -2726.5373535156, z = 7.1710538864136,  name = "Sair", destination = {28}},

    -- Coca 
    [30] = {id = 30, x = 1089.02734375, y = -3188.8713378906, z = -38.993465423584,  name = "Entrar", destination = {31}},
    [31] = {id = 31, x = 1195.9567871094, y = -3254.3439941406, z = 7.0951871871948,  name = "Sair", destination = {30}},- ]]

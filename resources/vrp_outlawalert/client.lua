...
Citizen.CreateThread( function()
    while true do
        ...
        onPedShotting(playerPed, plyPos, street1, street2)
    end
end)
...
Citizen.CreateThread( function()
    while true do
        ...
        if showOutlaw then
            ...
            for i = 0, 31 do
                playerIndex = GetPlayerPed(i)
                if DecorGetInt(playerIndex, "IsOutlaw") == 2 and playerIndex ~= playerPed then
                    gamerTagId = Citizen.InvokeNative(0xBFEFE3321A3F5015, playerIndex, ".", false, false, "", 0 )
                ...
                elseif DecorGetInt(playerIndex, "IsOutlaw") == 1 then

...
function renderRetirar(x,y,z)
    DrawMarker(29, 437.06619262696,-994.18487548828,31.68959236145-1.0001, 0, 0, 0, 0, 0, 0, 1.0001,1.0001,1.0001, 0, 232, 255, 155, 0, 1, 2, 0, 0, 0, 0)
    if Vdist2(x,y,z, 437.06619262696,-994.18487548828,30.68959236145) < 1 then
        DrawSpecialText("Digite ~y~/retirar (modelo do veiculo)~s~")
    end
end

function renderConsultar(x,y,z)
    DrawMarker(29, 440.95288085938,-981.49865722656,31.689601898194-1.0001, 0, 0, 0, 0, 0, 0, 1.0001,1.0001,1.0001, 0, 232, 255, 155, 0, 1, 2, 0, 0, 0, 0)
    if Vdist2(x,y,z, 440.95288085938,-981.49865722656,30.689601898194) < 1 then

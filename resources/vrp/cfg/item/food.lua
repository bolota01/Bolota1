...
items["sorvetepa"] = {"Picolé de Abacaxi","", gen("eat",-15,0),0.7}
items["sorveteplc"] = {"Picolé de Leite Condensado","", gen("eat",-15,0),0.7}
items["sorvetepl"] = {"Picolé de Limão","", gen("eat",-15,0),0.7}
items["sorvetepu"] = {"Picolé de Uva","", gen("eat",-15,0),0.7}

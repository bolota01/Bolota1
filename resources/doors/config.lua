...
cfg.list = {
  ...
  [3] = { offset = -1.2, mystatus = false, hash = -1320876379, x = 447.23818969727, y = -980.63006591797, z = 30.689598083496, locked = true, key = "key_pd_boss", permission="boss_lspd.pc", name = "Escritório do Chefe LSPD"},

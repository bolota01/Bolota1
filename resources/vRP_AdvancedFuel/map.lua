...
station = {
    ...
    --{x=442.73794555664,y=-1014.3247680664,z=28.625051498413,s=1},
...
boat_stations = {
    ...
    {x=1109.065,y=-647.309,z=57.256,s=29},
    {x=1109.587,y=-651.450,z=57.242,s=29},
}


avion_stations = {
    {x=2133.268,y=4783.649,z=40.97,s=30},
    {x=1731.302,y=3310.969,z=41.224,s=31},
    {x=-1229.625,y=-2877.264,z=13.945,s=32},
}


heli_stations = {
    {x=1770.241,y=3239.716,z=42.127,s=33},
    {x=-1112.407,y=-2883.893,z=13.946,s=34},
    {x=481.930,y=-981.105,z=41.008,s=35},
}
...
stationsText[29] = {x=1111.042,y=-646.680,z=57.516}

--- Avions stations
stationsText[30] = {x=2129.667,y=4790.576,z=42.345}
stationsText[31] = {x=1735.045,y=3296.126,z=43.048}
stationsText[32] = {x=-1229.625,y=-2877.264,z=15.921}

--- Helicopters stations
stationsText[33] = {x=1770.241,y=3239.716,z=45.127}
stationsText[34] = {x=-1112.407,y=-2883.893,z=15.921}
stationsText[35] = {x=481.930,y=-981.105,z=41.008}
        ...
        for _, item in pairs(station) do
            ...
            if(near) then
                ...
                if(dist<10) then
               		...
               		DrawText3D(x,y,z-0.2, "~b~"..settings[lang].price.." R$ "..StationsPrice[item.s].." por litro")
               	end
            end
        end
